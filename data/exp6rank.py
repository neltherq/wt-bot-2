...
DB_PATH = os.getenv("DB_PATH") or os.path.join(os.path.dirname(__file__), "..", "accounts_rank6.sqlite3")
...
out_path = os.path.abspath(os.path.join(EXPORT_DIR, f"available_accounts6_{ts}.txt"))
